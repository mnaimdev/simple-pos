                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        @enderror">
                                            ...
                                            <option @if ($employee_info->experience == 1) selected="selected" @endif
                                                value="1">1 Year</option>
                                            <option @if ($employee_info->experience == 2) selected="selected" @endif
                                                value="2">2 Year</option>
                                            <option @if ($employee_info->experience == 3) selected="selected" @endif
                                                value="3">3 Year
                                            </option>
                                            <option @if ($employee_info->experience == 4) selected="selected" @endif
                                                value="4">4 Year
                                            </option>
                                            <option @if ($employee_info->experience == 5) selected="selected" @endif
                                                value="5">5 Year
                                            </option>
                                        </select>
                                        @error('experience')
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        @enderror
                                        <div class="my-1">
                                            <img src="{{ asset('/uploads/employee') }}/{{ $employee_info->image }}"
