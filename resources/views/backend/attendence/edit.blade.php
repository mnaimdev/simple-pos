@extends('admin')
@section('content')
    <link rel="stylesheet" href="{{ asset('/dashboard_assets/css/attend.css') }}">
    <style>
        .switch-toggle {
            width: auto;
        }
    ...
    <div class="container">
        <nav aria-label="breadcrumb"
            ...
            <a href="{{ route('attendence') }}" class="btn btn-info">List</a>

            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('attendence') }}">Attendece</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('attendence.update') }}" method="post" id="myForm">
                            @csrf
                                ...
                                <tbody>
                                    @foreach ($attendences as $key => $attendence)
                                        <tr class="text-center">
                                            ...
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $attendence['rel_to_employee']['name'] }}</td>
                                            <td colspan="3">
