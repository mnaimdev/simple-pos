                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="account_holder"
                                           ...
                                           is-invalid
                                       @enderror"
                                            value="{{ $supplier_info->account_holder }}">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <select name="type"
                                        ...
                                        <option {{ $supplier_info->type == 'Distributor' ? 'selected' : '' }}
                                            value="Distributor">Distributor</option>
                                        <option {{ $supplier_info->type == 'Whole Sale' ? 'selected' : '' }}
                                            value="Whole Sale">Whole Sale</option>
                                    </select>
                                    @error('type')
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="bank_branch"
                                            ...
                                            is-invalid
                                        @enderror"
                                            value="{{ $supplier_info->bank_branch }}">
                                        @error('bank_branch')
                                            <strong class="text-danger my-1">
                                                {{ $message }}
                                            </strong>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        @enderror
                                        <div class="my-1">
                                            <img src="{{ asset('/uploads/supplier') }}/{{ $supplier_info->image }}"
